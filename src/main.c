...
const char ALTAIR_EMULATOR_VERSION[] = "5.3.8";
...
static void *altair_thread(void *arg)
{
    ...
    while (true)
    {
        ...
        {
            i8080_cycle(&cpu);
            nanosleep(&(struct timespec){0, LOW_POWER_SLEEP_NS}, NULL);
        }
        else
        {
...
static void InitPeripheralAndHandlers(int argc, char *argv[])
{
    ...
    dx_initMonotonicMillisecondTimer();
    ...
    init_web_socket_server(client_connected_cb, client_disconnect_cb);
